package id.infinitelearning.KotlinSubmission.exercise1.myProfile
...
fun myProfile() {
    var namaDepan = "Meli"
    var namaBelakang = "syah"
    val umur = 21
    val statustrue = "Singel"
    val statusfalse = "Tidak"
    println(namaDepan + " Melisyah " + namaBelakang)
    println(umur)
 ...
 */
fun myGroup(): String {
    val groupMembers = listOf("Meli", "Tutik", "Haikal", "Bayu", "Hari")
 ...
 */
fun totalMember(): Int {
    val mentor = arrayOf("Hasan", "Shasa", "Lauren", "Reza")
    val countOfGroup = 6
...
fun main(args: Array<String>) {
     ...
     *
     */
    groupDetail(1, listOf("Meli", "Tutik", "Haikal", "Bayu", "Hari"), "Morning")
}
